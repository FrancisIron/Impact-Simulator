...
public class Calculista {
    ...
    public double calcular(TextField potencial, TextField baseCarga, TextField expCarga, TextField baseMasa, TextField expMasa, TextField campoElectrico, TextField distancia, TextField vel, TextField time, TextField difPotencial, TextField difEPotencial) {
        ...
        charge = juanito.createDouble(auxBase, auxExp);
        auxBase = Double.parseDouble(baseMasa.getText());
        auxExp = Integer.parseInt(expMasa.getText());
        mass = juanito.createDouble(auxBase, auxExp);
        ...
        vel.setText(juanito.createString(speed));
        time.setText(juanito.createString(resultTime));
        difPotencial.setText("-" + potencial.getText());
        difEPotencial.setText(juanito.createString(EPot));
